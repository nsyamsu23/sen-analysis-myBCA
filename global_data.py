import pandas as pd
# Load your data once and store it in a variable
import pandas as pd
...
baku_data = pd.read_excel("https://github.com/nsyamsu23/kamus/raw/main/kamuskatabaku.xlsx")
chat_words_mapping = {
    "@": "di",
...
def get_data(data_type):
    if data_type == "reviews":
        ...
        return "Invalid data type. Choose 'reviews' or 'emoji'."
# Function to update the data
def update_data(new_data):
    global df_reviews_all
    df_reviews_all = new_data
